  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarBottom">
      <ul class="navbar-nav">
        ...
        <li class="nav-item"><a class="nav-link active" href="computadoras.php">Computadoras</a></li>
  ...
  <div class="row g-4">
    ...
    <div class="col-md-3">
      <div class="card h-100">
          ...
          <a href="detalle_producto.php?id=26" class="btn btn-primary w-100">Comprar</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-3">
      <div class="card h-100">
          ...
          <a href="detalle_producto.php?id=22" class="btn btn-primary w-100">Comprar</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-3">
      <div class="card h-100">
        ...
        <div class="card-body">
          ...
          <a href="detalle_producto.php?id=28" class="btn btn-primary w-100">Comprar</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-3">
      <div class="card h-100">
        ...
        <div class="card-body">
          ...
          <a href="detalle_producto.php?id=25" class="btn btn-primary w-100">Comprar</a>
        </div>
      </div>
    </div>
