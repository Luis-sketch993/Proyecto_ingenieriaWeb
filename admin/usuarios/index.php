        ...
        <div class="row">
            ...
            <div class="col-md-10 content">
                <div class="header-action">
                    ...
                    <a href="crear.php" class="btn btn-success"><i class="bi bi-plus-circle"></i> Nuevo Usuario</a>
                </div>
                            ...
                            <?php else: ?>
                                <?php foreach ($usuarios as $user): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="editar.php?id=<?= $user['id'] ?>" class="btn btn-primary btn-sm"><i class="bi bi-pencil"></i></a>
                                            <a href="eliminar.php?id=<?= $user['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('¿Está seguro?')"><i class="bi bi-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php endif; ?>
