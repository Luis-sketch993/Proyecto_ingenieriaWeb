        ...
        <div class="row">
            ...
            <div class="col-md-10 content">
                <div class="header-action">
                    <h2><i class="bi bi-tag"></i> Gestión de Categorías</h2>
                    <a href="crear.php" class="btn btn-success"><i class="bi bi-plus-circle"></i> Nueva Categoría</a>
                </div>
                            ...
                            <?php else: ?>
                                <?php foreach ($categorias as $cat): ?>
                                    <tr>
                                        ...
                                        <td><?= htmlspecialchars(substr($cat['descripcion'], 0, 60)) ?>...</td>
                                        <td>
                                            <a href="editar.php?id=<?= $cat['id'] ?>" class="btn btn-primary btn-sm"><i class="bi bi-pencil"></i></a>
                                            <a href="eliminar.php?id=<?= $cat['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('¿Está seguro?')"><i class="bi bi-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php endif; ?>
