...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($nombre) || empty($descripcion)) {
        ...
        if ($stmt->execute()) {
            header("Location: index.php?success=Categoría creada exitosamente");
            exit();
        } else {
        ...
        <div class="row">
            ...
            <div class="col-md-10 content">
                <div class="mb-4">
                    ...
                    <h2 class="d-inline ms-2"><i class="bi bi-plus-circle"></i> Crear Categoría</h2>
                </div>
                    ...
                    <div class="card-body p-4">
                        <form method="POST">
                            ...
                            <div class="d-flex gap-2">
                                <button type="submit" class="btn btn-primary"><i class="bi bi-check-circle"></i> Crear Categoría</button>
