  ...
  <div class="container-fluid">
    <div class="collapse navbar-collapse" id="navbarNav">
      <h1 class="d-flex align-items-center gap-2">
        ...
        <li class="navbar-item"><a class="nav-link" href="favoritos_lista.php"><i class="bi bi-heart"></i> Favoritos</a></li>
...
<!--
      ...
      <ul class="navbar-nav ms-auto">
        <li class="navbar-item">
          ...
          <a class="navbar-link" href="#"><i class="bi bi-heart"></i> Favoritos</a>
        </li>
        <li class="navbar-item">
    ...
    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
      <div class="card h-100">
        ...
        <div class="card-body">
          ...
          <a href="detalle_producto.php?id=11" class="btn btn-primary w-100">Comprar</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
      <div class="card h-100">
        ...
        <div class="card-body">
          ...
          <a href="detalle_producto.php?id=13" class="btn btn-primary w-100">Comprar</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
      <div class="card h-100">
        ...
        <div class="card-body">
          ...
          <a href="detalle_producto.php?id=14" class="btn btn-primary w-100">Comprar</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
      <div class="card h-100">
        ...
        <div class="card-body">
          ...
          <a href="detalle_producto.php?id=15" class="btn btn-primary w-100">Comprar</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
      <div class="card h-100">
        ...
        <div class="card-body">
          ...
          <a href="detalle_producto.php?id=16" class="btn btn-primary w-100">Comprar</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
      <div class="card h-100">
        ...
        <div class="card-body">
          ...
          <a href="detalle_producto.php?id=17" class="btn btn-primary w-100">Comprar</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
      <div class="card h-100">
        ...
        <div class="card-body">
          ...
          <a href="detalle_producto.php?id=18" class="btn btn-primary w-100">Comprar</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
      <div class="card h-100">
        ...
        <div class="card-body">
          ...
          <a href="detalle_producto.php?id=19" class="btn btn-primary w-100">Comprar</a>
        </div>
      </div>
    </div>
  </div>
